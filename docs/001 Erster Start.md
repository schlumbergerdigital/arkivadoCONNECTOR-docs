...
!!! note ""
    ...
    -> [Konfiguration des ecoDMS API Zugriffs](<002 Vorbereitung ecoDMS.md>)

1. Anlage Benutzer und Passwort   

    ![anlage arkivado CONNECTOR Benutzer](21-05-2026_15-57-28.png)   

2. Aktivierung der Lizenz aus der zugesandten E-Mail   
    
    ![Eingabe Lizenzschlüssem vom CONNCETOR](image-21.png)
